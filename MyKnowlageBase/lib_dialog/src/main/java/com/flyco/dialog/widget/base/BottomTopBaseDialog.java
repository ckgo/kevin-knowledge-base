...
public abstract class BottomTopBaseDialog<T extends BottomTopBaseDialog<T>> extends BaseDialog<T> {
    ...
    /**
     * 设置动画进入和退出的时间 默认200毫秒
     *
     * @param value
     */
    public void setAnimDuration(long value) {
        this.mInnerAnimDuration = value;
    }

    /**
     * 设置弹出dialog时，是否显示window动画
     *
     * @param value
     */
    public void setShowWindowAnim(boolean value) {
        this.isShowWindowAnim = value;
    }
